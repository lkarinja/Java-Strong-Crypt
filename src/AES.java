/*
 * ----------------------------------------------------------------------------
 * "THE BEER-WARE LICENSE" (Revision 42): <dweymouth@gmail.com> wrote this file.
 * As long as you retain this notice you can do whatever you want with this
 * stuff. If we meet some day, and you think this stuff is worth it, you can buy
 * me a beer in return. D. Weymouth 4/2014
 * ----------------------------------------------------------------------------
 */
...
public class AES {
    ...
    private static final int SALT_LENGTH = 64; // in bytes
    private static final int AUTH_KEY_LENGTH = 32; // in bytes
     ...
     *             256, but the Java runtime's jurisdiction policy files do not
     *             allow 192- or 256-bit encryption
     * @throws IOException
     */
    public static void encrypt(int keyLength, char[] password, InputStream input, OutputStream output) throws InvalidKeyLengthException, StrongEncryptionNotAvailableException, IOException {
        ...
        } catch (NoSuchAlgorithmException | NoSuchPaddingException impossible) {} catch (InvalidKeyException e) { // 192 or 256-bit AES not available
     ...
     * @throws AES.InvalidPasswordException if the given password was not used
     *             to encrypt the data
     * @throws AES.InvalidAESStreamException if the given input stream is not a
     *             valid AES-encrypted stream
     * @throws AES.StrongEncryptionNotAvailableException if the stream is 192 or
     *             256-bit encrypted, and the Java runtime's jurisdiction policy
     *             files do not allow for AES-192 or 256
     * @throws IOException
     */
    public static int decrypt(char[] password, InputStream input, OutputStream output) throws InvalidPasswordException, InvalidAESStreamException, IOException, StrongEncryptionNotAvailableException {
        ...
        } catch (NoSuchAlgorithmException | NoSuchPaddingException | InvalidAlgorithmParameterException impossible) {} catch (InvalidKeyException e) { // 192 or 256-bit AES not available
            throw new StrongEncryptionNotAvailableException(keyLength);
        }
    ...
    public static class InvalidPasswordException extends Exception {
         ...
         * 
         */
        private static final long serialVersionUID = 2232292688742767880L;
    }
    ...
    public static class InvalidKeyLengthException extends Exception {
         ...
         * 
         */
        private static final long serialVersionUID = -4341733522505364635L;
    ...
    public static class StrongEncryptionNotAvailableException extends Exception {
         ...
         * 
         */
        private static final long serialVersionUID = -4357612467509947007L;
    ...
    public static class InvalidAESStreamException extends Exception {
         ...
         * 
         */
        private static final long serialVersionUID = -4990594785342257501L;
